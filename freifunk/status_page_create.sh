...
echo '  <a href="counter.svg">Counter</a> / <a href="https://vpn5.freifunk-ulm.de/meshviewer">Meshviewer</a><br />'
echo '  <a href="/vnstat">VNStat</a> / <a href="https://vpn5.freifunk-ulm.de/munin">Munin</a><br />'
echo '  <a href="https://vpn5.freifunk-ulm.de/firmware">Firmware</a><br />'
echo '</td>'
