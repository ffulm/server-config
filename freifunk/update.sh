...
if [ $run_map = 1 ]; then
	...
	# --nodelist is for freifunk-karte.de
	./map-backend.py -m /tmp/maps.txt --storage disappeared_nodes_buffer --meshviewer-org /var/www/data/meshviewer.json --nodelist /var/www/data/nodelist.json
